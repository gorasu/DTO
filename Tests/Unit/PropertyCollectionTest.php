...
use Gora\DTO\Mappings\Property\PropertyValidateInterface;
...
class PropertyCollectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    function setUp()
    {
        $this->propertyCollection = new PropertyCollection(new PropertyValidator());
        $this->properties = array_fill(0,5,$this->getMockBuilder(PropertyValidateInterface::class)->getMock());
